...
const _contextKey = '$$_urql_subscriptions';
 ...
 */
export const getContextSubscriptionsClient = (): Client => {
 ...
 */
export const setContextSubscriptionsClient = (client: Client): void => {
 ...
 */
export const initContextSubscriptionsClient = (args: ClientOptions): Client => {
    const client = new Client(args);
    setContextSubscriptionsClient(client);
    return client;
};